...
var Inspector = /*#__PURE__*/function () {
  ...
  _createClass(Inspector, [{
    ...
    value: function __highlight(el) {
      ...
      var bBox = el.getBoundingRect().clone();
      bBox.applyTransform(el.transform);
      self.__highlightDom.style.display = 'block';
      self.__highlightDom.style.left = "".concat((zrInsDomBBox.x + bBox.x).toFixed(2), "px");
      self.__highlightDom.style.top = "".concat((zrInsDomBBox.y + bBox.y).toFixed(2), "px");
    ...
    value: function __bindEvents() {
      ...
      function handleZrMouseMove(event) {
        ...
        var el = event.target.type === 'tspan' ? event.target.parent : event.target;
        if (hoverEl === el) {
          return;
        }
        hoverEl = el;
    ...
    value: function destroy() {
      ...
      this.__unbinds = [];
      (_this$__highlightDom = this.__highlightDom) === null || _this$__highlightDom === void 0 || _this$__highlightDom.remove();
      this.__highlightDom = null;
      (_this$__highlightTool = this.__highlightTooltipDom) === null || _this$__highlightTool === void 0 || _this$__highlightTool.remove();
